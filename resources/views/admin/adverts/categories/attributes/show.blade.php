...
@section('content')
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            <th>Category</th><td><a href="{{ route('admin.adverts.categories.show', $category) }}">{{ $category->name }}</a></td>
        </tr>
        <tr>
            <th>Type</th><td>{{ $attribute->type }}</td>
        </tr>
        <tr>
            <th>Type</th><td>{{ $attribute->sort }}</td>
        </tr>
        <tr>
            <th>Required</th><td>{{ $attribute->isRequired() ? 'Yes' : 'No' }}</td>
        </tr>
        <tr>
            <th>Variants</th><td>{{ $attribute->getVariantList() }}</td>
        </tr>
        <tbody>
        </tbody>
    </table>
